...
def calculate_metric(reference_folder_path, noise):
...
if __name__ == '__main__':
  ...
  parser.add_argument('--noise', required=True, type=str, help='The type of noise of the results')
  args = parser.parse_args()

  reference_image = calculate_metric(args.reference_folder_path, args.noise)
