...
def plot_histogram(reference_folder_path, noise_image, output_three_channels, output_final):
...
if __name__ == '__main__':
  ...
  reference_image = plot_histogram(args.reference_folder_path, args.noise_image, args.output_three_channels, args.output_final)